...
set(GITREV_FILE ${koopmans-qe-utils_BINARY_DIR}/${GITREV_BARE_FILE})
set(GITREV_TMP ${koopmans-qe-utils_BINARY_DIR}/${GITREV_BARE_TMP})
...
execute_process(
    ...
    WORKING_DIRECTORY ${koopmans-qe-utils_SOURCE_DIR} OUTPUT_STRIP_TRAILING_WHITESPACE)
